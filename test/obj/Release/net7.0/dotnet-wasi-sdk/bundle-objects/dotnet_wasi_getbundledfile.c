...
extern const unsigned char test_dll_1CB766DA[];
extern const int test_dll_1CB766DA_len;
...
void dotnet_wasi_registerbundledassemblies() {
  mono_wasm_add_assembly ("test.dll", test_dll_1CB766DA, test_dll_1CB766DA_len);
